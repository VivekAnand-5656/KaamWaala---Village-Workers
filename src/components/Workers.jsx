...
function Workers({workers,setWorkers}) { 
    ...
    return <>
        ...
        <div className=' w-[100vw] mt-[15vh] p-2 flex justify-center items-center  ' >
            <form onSubmit={handleSubmit} action="" className=' register border sm:w-[40%] w-[100%] sm:h-[100%] h-[100%] mx-auto flex flex-col sm:py-1 sm:px-5 p-2 sm:rounded-[1rem]  ' >
