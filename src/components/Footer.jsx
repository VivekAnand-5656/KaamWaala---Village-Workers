    ...
    return ( 
        <footer class="bg-[#1EA1CF] shadow-sm ">
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <span class="block text-sm text-white sm:text-center dark:text-white">© 2025 <a href="https://flowbite.com/" class="hover:underline">KaamWala</a>. All Rights Reserved.</span>
            </div>
        </footer>
