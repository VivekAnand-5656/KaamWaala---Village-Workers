...
function App() {
   return <>
      <Navbar />
      {/* Hero Section */}
      <main className=' hero sm:w-[80%] w-[100%] mx-auto sm:h-[85vh] h-[100vh] flex sm:flex-row flex-col justify-center items-center p-2 sm:mt-[15vh] mt-[10vh]  transition-all ease-in-out duration-500 ' >
         <div className='box  sm:w-full sm:h-[100%] flex sm:flex-row flex-col justify-center items-center rounded-[1rem] p-3 ' >
            <div className='sm:w-[50%] w-[100%] sm:h-full h-[50%] flex flex-col justify-center items-center  '>
               <h1 className='tst sm:text-[3rem] text-[3rem] font-bold uppercase  ' >Viilage Labour Job Finder</h1>
      ...
      {/* --- Why use this --- */}
      <h1 className='text-[2rem] text-center capitalize font-bold sm:mt-0 mt-2 ' >why use this plateform</h1>
      ...
      <div className=' sm:w-[80%] w-[100%] sm:h-[80vh] h-[70vh] mx-auto sm:rounded-[3rem] rounded-[0] bg-[#1EA1CF] border-t-2 border-[#fff] flex sm:flex-row flex-col justify-center items-center p-2 ' >
         ...
         <div className='sm:w-[50%] w-[100%] sm:h-full h-[40%] flex flex-col justify-center gap-3 sm:gap-0 ' >
         ...
         <div className='sm:w-[40%] w-[100%] sm:h-full h-[60%]  ' >
