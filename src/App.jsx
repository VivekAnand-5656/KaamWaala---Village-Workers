...
function App() {
   return <>
      <Navbar />
      {/* Hero Section */}
      <main className=' hero sm:w-[80%] w-[100%] mx-auto sm:h-[85vh] h-[70vh] flex sm:flex-row flex-col justify-center items-center p-2 sm:mt-[15vh] mt-[10vh]  transition-all ease-in-out duration-500 ' >
         <div className='box  sm:w-full w-full sm:h-[100%] h-full flex sm:flex-row flex-col sm:justify-center justify-around   items-center rounded-[1rem] p-3 ' >
            <div className='sm:w-[50%] w-[100%] sm:h-full h-[30%] flex flex-col justify-center items-center  '>
               <h1 className='tst sm:text-[3rem] text-[2rem] font-bold uppercase  ' >Viilage Labour Job Finder</h1>
